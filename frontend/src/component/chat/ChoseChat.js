    ...
    return (
        <div style={{
            ...
            <Card style={{ width: '18rem' }}>
                <Card.Img
                    variant="top"
                    src="https://via.placeholder.com/286x180.png?text=Chat+v%E1%BB%9Bi+b%C3%A1c+s%C4%A9"
                    alt="Chat với bác sĩ"
                />
                <Card.Body>
                    <Card.Title>Trao đổi với bác sĩ</Card.Title>
                    <Card.Text>
                        Trò chuyện trực tiếp với bác sĩ để được tư vấn chuyên sâu về sức khỏe tinh thần.
                    </Card.Text>
                    <Nav>
                        <NavLink to="/chat">
